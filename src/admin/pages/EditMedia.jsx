...
export default function EditMedia() {
  ...
  useEffect(() => {
    const fetchMedia = async () => {
      try {
        ...
        setTitleEn(media.title?.en || "")
        setTitleKn(media.title?.kn || "")
        setDescEn(media.description?.en || "")
        setDescKn(media.description?.kn || "")
        setCategory(media.category || "other")
        setType(media.type || "image")
        setVideoUrl(media.videoUrl || "")
        setCurrentImage(media.image || "")
      } catch (error) {
        console.error(error)
      } finally {
        setLoading(false)
  ...
  const categoryColors = {
    ...
    festival: "bg-secondary/20 text-secondary/80 border-secondary/30",
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Update your media item details
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      ...
                      <span className={`text-xs font-medium px-3 py-1 rounded-full border ${categoryColors[category]}`}>
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              <p className="text-sm font-medium text-gray-700">
                                {imagePreview ? 'Click to change image' : 'Click to upload new image'}
                              </p>
